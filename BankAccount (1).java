...
public class BankAccount {
	...
	public static void main(String[] args) {
		...
		BankAccount zippo = myAccount;

		BankAccount yourAccount = new BankAccount();
		
		yourAccount.deposit(30000.00);
		yourAccount.withdraw(3000.00);
		yourAccount.setId("ABC1245");
		yourAccount.setOwner("Mary Jones");
		yourAccount.printInfo();
